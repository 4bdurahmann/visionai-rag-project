...
const Doctors: React.FC = () => {
  ...
  return (
    <section id="doctors" className="w-full bg-[#EBF0FA] px-4 py-20">
          ...
          {doctorsData.map((doc) => {
            ...
            return (
              <div
                ...
                className="relative rounded-[32px] overflow-hidden bg-[#F2F5FB] border border-white/80 shadow-xs h-[380px] md:h-[420px] flex flex-col justify-end cursor-pointer group transition-all duration-300 hover:shadow-md"
              >
                ...
                {isActive && (
                  <div className="relative z-10 m-3 p-4 bg-white/95 backdrop-blur-md rounded-[24px] shadow-lg border border-white/80 text-left animate-fade-in">
                    ...
                    <button className="w-full bg-[#4169E1] hover:bg-blue-700 text-white font-medium text-xs py-2 px-4 rounded-full transition-colors shadow-xs">
                      Book Appointment
                    </button>
                  </div>
                )}
