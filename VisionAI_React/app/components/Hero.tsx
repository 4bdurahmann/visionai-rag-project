    ...
    <section className="w-full bg-[#EBF0FA] px-4 pb-10 pt-4 overflow-hidden">
      <div className="max-w-[1400px] mx-auto bg-gradient-to-br from-[#F5F8FF] via-[#EEF3FD] to-[#E5EDFB] rounded-[40px] relative px-8 lg:px-16 pt-12 pb-24 border border-white/90 shadow-lg overflow-hidden">
        ...
        <div className="absolute top-8 right-8 lg:right-16 z-20 flex items-center gap-2 bg-white/60 backdrop-blur-md p-1.5 rounded-full border border-white/80 shadow-sm">
          <a href="https://github.com/4bdurahmann/visionai-rag-project" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-full bg-white text-gray-800 font-bold text-xs flex items-center justify-center hover:bg-gray-50 transition-all shadow-xs" aria-label="LinkedIn">
            in
          </a>
          <a href="https://github.com/4bdurahmann/visionai-rag-project" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-full bg-transparent text-gray-600 font-bold text-xs flex items-center justify-center hover:bg-white/40 transition-all" aria-label="GitHub">
            GH
          </a>
          <a href="https://github.com/4bdurahmann/visionai-rag-project" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-full bg-transparent text-gray-600 font-bold text-sm flex items-center justify-center hover:bg-white/40 transition-all" aria-label="Repository">
            ⌥
          </a>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6 pt-4">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <Link
                to="/clinical-rag"
                className="bg-[#111827] hover:bg-black text-white font-medium px-6 py-3 rounded-full text-xs transition-all shadow-md"
              >
                Ask a Question →
              </Link>
            </div>
